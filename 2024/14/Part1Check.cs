...
public class Part1Check(List<string> input)
{
    ...
    public void Solve()
    {
        ...
        var coordinates = Enumerable.Range(0, gridSize.height).SelectMany(y => Enumerable.Range(0, gridSize.width).Select(x => (x, y))).ToList();
